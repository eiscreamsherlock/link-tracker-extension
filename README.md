## Track Some Links In Your Browser
(for great justice)

---

Following along with another [Scrimba JS Course Module](https://scrimba.com/learn-javascript-c0v).

This time we're making a little Chrome Extension to "enable our sales folks to track leads URLs".
